...
<html>
    ...
    <body>
        ...
        <form id="pwreset-form" method="post" action="<?php $thisfile?>">
        ...
        <form id="email-form" method="post" action="<?php $thisfile?>">
        ...
        <?php
            ...
            if (isset($_GET['wwcode'])) {
                ...
                if (strlen($wwcode) > 0) {
                    $link = $thisfile. "?wwcode=$wwcode";
                    $boodschap = "Klik hierop om uw wachtwoord te kunnen wijzigen: $link";
            ...
            function wachtwoord_wijzigen($email, $wachtwoord) {
                ...
                if (bestaat_al($email)) {
                    ...
                    $stmt = $db->prepare("UPDATE Lezers SET wachtwoord='$wachtwoord'
                                          WHERE email='$email'");
